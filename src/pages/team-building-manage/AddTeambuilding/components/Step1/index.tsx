      ...
      <Form className={ styles.stepForm }
        ...
        <Row gutter={ FormRowLayoutSpan }>
          <Col span={ FormItemLayoutSpan }
            offset={ FormItemLayoutOffset }>
            <Form.Item label="团建名称"
              name="name"
          ...
          <Col span={ FormItemLayoutSpan }
            ...
            <Form.Item label="活动人数"
              ...
              <InputNumber placeholder={ '请输入活动人数' }
                min={ 1 }
                style={ { width: '100%' } }/>
            </Form.Item>
          </Col>
          <Col span={ FormItemLayoutSpan }
            ...
            <Form.Item label="类别"
              ...
              <Select placeholder={ '请选择类别' }>
                { activityTypeConfig().map(( type, v ) => {
                    return (
                      <OptGroup label={ type.text } key={v}>
                        {
        ...
        <Row gutter={ 2 * FormRowLayoutSpan }>
          <Col span={ 4 * FormItemLayoutSpan }
            offset={ FormItemLayoutOffset }>
            <Form.Item label="团建收益"
              name="profits"
        ...
        <Form.Item label="策划者头像"
          name="avatar"
          rules={ [ { message: '请上传策划者头像' } ] }>
          <UploadComponent/>
        </Form.Item>
        ...
        <Row gutter={ FormRowLayoutSpan }>
          <Col span={ 8 }
            offset={ FormItemLayoutOffset }>
            <Form.Item label="活动特色"
              name="description"
              rules={ [ { required: true, message: '请输入活动特色' } ] }>
              <TextArea placeholder="活动特色"
        ...
        <Space style={ {
          ...
          <Form.Item>
            ...
            { allSubmitButton }
            {
              isCopy && <Button type="primary"
                onClick={ () => onValidateForm('submit') }
                loading={ submitting }
                style={ { marginLeft: 8 } }>
                提交
              </Button>
